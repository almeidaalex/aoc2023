...
[<Fact>]
let ``Should sum calibrations combined, digits and spelled`` () =
  let calibrations = ["two1nine";"eightwothree";"abcone2threexyz";"xtwone3four";"4nineeightseven2";"zoneight234";"7pqrstsixteen";"1abc2";"pqr3stu8vwx";"a1b2c3d4e5f";"treb7uchet"]
  let sum = Day1.SumCalibrations calibrations

  Assert.Equal( 423, sum)
